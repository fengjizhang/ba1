...
// client.query(`DROP DATABASE IF EXISTS qa`, (err, res) => {
//   err ? console.log(err): console.log('done! dropped database');
// })

// client.query(`CREATE DATABASE qa`, (err, res) => {
//   err ? console.log(err): console.log('done! created database');
// })
